...
class DataService {
    ...
    void populateData() {
        ...
        Bribe.build(name: 'Hot Wheels', probability: 10, availableCount: 2, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'Chocolate', probability: 15, availableCount: 3, bribePortfolio: bp, picture: null)
        Bribe.build(name: '$100', probability: 1, availableCount: 1, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'Playtime', probability: 10, availableCount: 4, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'Movie', probability: 10, availableCount: 2, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'TV', probability: 10, availableCount: -1, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'Sleepover', probability: 5, availableCount: 3, bribePortfolio: bp, picture: null)
        Bribe.build(name: 'Pizza', probability: 2, availableCount: 1, bribePortfolio: bp, picture: null)
