...
class ShakeController {
     ...
     */
    def shake() {
        render shakeService.shakeForBribe(BribePortfolio.get(params.bribeportfolio.id), Benefactor.get(params.benefactor.id), Recipient.get(params.recipient.id), Opportunity.get(params.opportunity.id)).toString()
    }
}
